...
class CLASSIFIER:
    # train_Y is interger
    def __init__(self, _train_X, _train_Y, test_seen_feature, test_seen_label, test_unseen_feature, test_unseen_label, seenclasses, unseenclasses, _nclass, device, _lr=0.001, _beta1=0.5, _nepoch=20, _batch_size=100, generalized=True):
        self.train_X = _train_X.clone()
        self.train_Y = _train_Y.clone()
        self.test_seen_feature = test_seen_feature.clone()
        self.test_seen_label = test_seen_label
        self.test_unseen_feature = test_unseen_feature.clone()
    ...
    def val_gzsl(self, test_X, test_label, target_classes):
        ...
        for i in range(0, ntest, self.batch_size):
            ...
            inputX = Variable(test_X[start:end].to(self.device))
    ...
    def val(self, test_X, test_label, target_classes):
        ...
        acc = self.compute_per_class_acc(map_label(test_label, target_classes), predicted_label, target_classes.shape[0])
        return acc
